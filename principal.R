...
print('Vefiricando o dataframe AMOSTRA...')
  dim(AMOSTRA)
  as.numeric(head(AMOSTRA$contador, 10))
  as.numeric(tail(AMOSTRA$contador, 10))
  summary(AMOSTRA$LOCNASC)

cat('--> Tem algum erro que está trazendo NAs na amostra', '\n')
cat('--> Precisamos descobrir qual!', '\n')
